...
export const LiquidGlassCard = ({
  ...
  // Use transform for movement — keeps backdrop-filter working
  // overflow is NOT hidden so the card is never clipped while dragging
  const cardStyle = {
    ...
    position: 'relative',
    // No overflow:hidden — that clips backdrop-filter when translating
    ...style,
  };
  ...
  return (
    ...
    >
      ...
      {/* Invisible drag zone — cursor-grab strip at top, no visible element */}
      {draggable && (
        <div
          ref={dragHandleRef}
          style={{
